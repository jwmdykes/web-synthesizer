  ...
  return (
    <>
      <div
        ...
        onPointerUp={props.mouseUpCallback}
      >
        <div className="font-semibold text-gray-700 bg-white rounded-b-md w-full h-full border border-gray-950 hover:cursor-pointer hover:bg-slate-200 flex items-end justify-center pb-6">
          {props.letter}
        </div>
        {props.children}
      </div>
